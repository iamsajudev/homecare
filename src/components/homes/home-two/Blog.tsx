            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-7 col-md-10">
                  <div className="section-title text-center">
                     <h5 className="sub-title double-line">Care Insights</h5>
                     <h2 className="title">Latest Home Care Resources & Tips</h2>
                     <p className="content">Explore helpful guides, family caregiver tips, and updates regarding private-pay and private insurance home care services[cite: 1].</p>
                  </div>
               </div>
            </div>
                     ...
                     <div className="single-blog-inner style-2">
                        ...
                        <div className="details">
                           ...
                           <ul className="blog-meta">
                              <li><i className="far fa-user"></i> By Hope & Cherish</li>
