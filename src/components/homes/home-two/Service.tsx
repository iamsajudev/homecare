            ...
            <div className="section-title">
               <div className="row">
                  <div className="col-xl-6 col-lg-7 mb-4 mb-lg-0">
                     ...
                     <p className="content mt-2">Providing high-quality private-pay and private insurance care tailored to your family's needs across New York .</p>
                  </div>
                  <div className="col-xl-6 col-lg-5 align-self-center">
                     <div className="btn-wrap text-md-end">
                        <Link className="it-btn btn-base" href="/service">Discover More Services</Link>
                     </div>
                  </div>
               </div>
            </div>
