            ...
            <div className="row justify-content-center">
               <div className="col-lg-6 col-md-10">
                  <div className="section-title text-center">
                     <h5 className="sub-title double-border">Our Process</h5>
                     <h2 className="title">How We Get Started</h2>
                     <p className="content">Simple and transparent steps to arrange private-pay or private insurance home care services for your loved ones[cite: 1].</p>
                  </div>
               </div>
            </div>
